...
```bash
kubectl apply --server-side -f https://raw.githubusercontent.com/openchoreo/openchoreo/refs/heads/release-v1.0/samples/component-types/component-web-app/webapp-component.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/refs/heads/release-v1.0/samples/component-types/component-web-app/webapp-component.yaml
```
