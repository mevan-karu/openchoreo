...
```bash
kubectl apply --server-side -f https://raw.githubusercontent.com/openchoreo/openchoreo/refs/heads/release-v1.0/samples/component-types/component-with-configs/component-with-configs.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/refs/heads/release-v1.0/samples/component-types/component-with-configs/component-with-configs.yaml
```
