...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-source/services/go-docker-greeter/greeting-service.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-source/services/go-docker-greeter/greeting-service.yaml
```
