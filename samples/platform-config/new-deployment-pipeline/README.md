...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/platform-config/new-deployment-pipeline/deployment-pipeline.yaml
```
