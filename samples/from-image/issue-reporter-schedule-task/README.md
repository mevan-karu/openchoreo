...
```bash
kubectl apply --server-side -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-image/issue-reporter-schedule-task/github-issue-reporter.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-image/issue-reporter-schedule-task/github-issue-reporter.yaml
```
