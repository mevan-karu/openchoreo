...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-image/echo-websocket-service/echo-websocket-service.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-image/echo-websocket-service/echo-websocket-service.yaml
```
