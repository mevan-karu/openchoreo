...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-image/react-starter-web-app/react-starter.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.0/samples/from-image/react-starter-web-app/react-starter.yaml
```
